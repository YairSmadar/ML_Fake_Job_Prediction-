...
#  look at the top 20 most common words being used in both fake postings as well as good job postings.
...
#  display the most 20 common words in fake jobs
...
#  display the most 20 common words in real jobs
fig = plt.figure(figsize=(20, 10))
pal = sns.color_palette("cubehelix", 20)
...
# set hot vector to the most significant columns and clean all irrelevant columns
